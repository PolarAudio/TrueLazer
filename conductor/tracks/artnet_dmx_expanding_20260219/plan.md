...
- [ ] Task: Implement Master Section Handlers
    - [ ] Update `ArtnetContext.jsx` to process hardcoded "Master Section" channels (1-10)
    - [ ] Link Master Intensity, Global Blackout, Page Select, and Transport to application actions
- [ ] Task: Implement Layer Footprint Logic
    - [ ] Create a "fixed-patch" processor that maps Layer 1-5 to sequential footprints (start channel 11)
    - [ ] Implement range-based clip triggers (0-10 Off, 11-20 Clip 1, etc.)
