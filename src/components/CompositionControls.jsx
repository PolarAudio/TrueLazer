        ...
        <div className="composition-controls">
            ...
            <Mappable id="comp_clear">
                <span
                    ...
                    onClick={onClearAllActive}
                    style={{ cursor: 'pointer' }}
                    draggable
                    onDragStart={(e) => handleDragStart(e, 'clear')}
                >
