  ...
  return (
    <div className="transport-controls">
      <Mappable id="transport_play">
        <button className={`speed-control-button ${isPlaying ? 'active' : ''}`} onClick={onPlay}>
      ...
      <Mappable id="transport_pause">
        <button className={`speed-control-button ${(!isPlaying && !isStopped) ? 'active' : ''}`} onClick={onPause}>
      ...
      <Mappable id="transport_stop">
        <button className={`speed-control-button ${isStopped ? 'active' : ''}`} onClick={onStop}>
